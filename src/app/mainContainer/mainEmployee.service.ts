...
export class MainEmployeeService{
    ...
    public getEmployees(): EmployeeType[]{
        return [...this.employees];
    }

    public addEmployees(employee: EmployeeType): void{
    ...
    public getEmployeeDetailsById(id: number): EmployeeType {
        const employee = this.employees.filter((emp) => emp.id === id);
